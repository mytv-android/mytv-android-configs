  ...
  <div class="flex flex-col gap-4">
    <VanCellGroup inset>
      <VanCell title="开发者模式" center>
        <template #value>
          <VanSwitch v-model="configs.data.debugDeveloperMode" />
        </template>
      </VanCell>

      <VanCell title="FPS显示" center>
        <template #value>
          <VanSwitch v-model="configs.data.debugShowFps" />
        </template>
      </VanCell>

      <VanCell title="显示播放器信息" center>
        <template #value>
          <VanSwitch v-model="configs.data.debugShowVideoPlayerMetadata" />
        </template>
      </VanCell>

      <VanCell title="显示布局网格" center>
        <template #value>
          <VanSwitch v-model="configs.data.debugShowLayoutGrids" />
        </template>
      </VanCell>
